        ...
        <div class="card-body">
            ...
            <form id="product-form" action="{{ route('admin.products.update', $viewData['product']) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" value="{{ old('name', $viewData['product']->getName()) }}" class="form-control">
                </div>
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="number" name="stock" value="{{ old('stock', $viewData['product']->getStock()) }}" class="form-control">
                    </div>
                    <div class="col">
                        <label class="form-label">@lang('admin.products.attributes.price')</label>
                        <input type="number" name="price" value="{{ old('price', $viewData['product']->getPrice()) }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="category" value="{{ old('category', $viewData['product']->getCategory()) }}" class="form-control">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" name="specs" id="specs-json" value="{{ json_encode($viewData['product']->getSpecs()) }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if ($viewData['product']->getImageUrl())
                        <div class="mb-2">
                            <img src="{{ asset($viewData['product']->getImageUrl()) }}" alt="{{ $viewData['product']->getName() }}" class="img-thumbnail" style="max-height:150px;">
                        </div>
                    @endif
