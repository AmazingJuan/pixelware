...
@section('additional-title', __('products.ranking.title'))
                                ...
                                <div class="mb-2 text-center">
                                    @if ($product->getAverageRating() > 0)
                                        <span class="fw-semibold text-warning">
                                            {{ number_format($product->getAverageRating(), 1) }} / 5
                                        </span>
                                        @for ($i = 1; $i <= 5; $i++)
                                        ...
                                        @endfor
                                    @else
                                        <span class="text-secondary">@lang('products.ranking.no_rating')</span>
                                    @endif
                                </div>
